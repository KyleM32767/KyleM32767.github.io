...
about:
  ...
  links:
    - icon: linkedin
      text: LinkedIn
      href: https://www.linkedin.com/in/kyle-mitard62/
    - icon: github
      text: Github
      href: https://github.com/KyleM32767
    - icon: envelope-at-fill
      text: Email
      href: mailto:krmitard@wpi.edu
    - icon: file-earmark-richtext
      text: Google Scholar
      href: https://scholar.google.com/citations?user=tloIyQIAAAAJ
    - icon: youtube
